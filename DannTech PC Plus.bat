...
:aleinu
mode 97,21
       set "asciiArt[0]=  ___    _____  _   _  _   _  _____  ___    ___    _   _ 
       set "asciiArt[1]= (  _`\ (  _  )( ) ( )( ) ( )(_   _)(  _`\ (  _`\ ( ) ( )
       set "asciiArt[2]= | | ) || (_) || `\| || `\| |  | |  | (_(_)| ( (_)| |_| |
       set "asciiArt[3]= | | | )|  _  || , ` || , ` |  | |  |  _)_ | |  _ |  _  |
       set "asciiArt[4]= | |_) || | | || |`\ || |`\ |  | |  | (_( )| (_( )| | | |
       set "asciiArt[5]= (____/'(_) (_)(_) (_)(_) (_)  (_)  (____/'(____/'(_) (_)
       set "asciiArt[6]= 
       set "asciiArt[7]=     
